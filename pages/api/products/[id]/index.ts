...
export default async function handler(
  ...
  if (req.method === "DELETE") {
    res.json({ id, message: "DELETE METHODU ISLEDI" });
    console.log("DELETE request daxil oldu!");
  } else {
    console.log(`Method ${req.method} bloklandı.`);
    res.json({ id, message: "DELETE METHODU ISLEmedI" });
  }
}
